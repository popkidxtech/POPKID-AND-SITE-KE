...
async function downloadSessionData() {
    ...
    const sessdata = config.SESSION_ID.split("POPKID-MD&")[1];
...
async function start() {
  ...
  if (initialConnection) {
    console.log(chalk.green("✅ Connected Successfully to Popkid-MD"));

    Matrix.sendMessage(Matrix.user.id, {
      image: { url: "https://files.catbox.moe/kiy0hl.jpg" },
      caption: `╭───❍ *Welcome to Popkid-MD* ❍───╮
...
╭────❍ *Details:* ❍────
├➤ *Prefix:* \`${prefix}\`
├➤ *Channel:* https://whatsapp.com/channel/0029VadQrNI8KMqo79BiHr3l
├➤ *GitHub:* https://github.com/Popkiddevs/POPKID-XTECH
╰──────────────────────

*Thanks for choosing POPKID-MD!*  
_©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴘᴏᴘᴋɪᴅ-ᴍᴅ_`
            });
